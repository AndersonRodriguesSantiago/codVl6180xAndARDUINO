...
void loop()
{
  ...
  */
  ...
  Serial.print("\nSensor1 = "); Serial.print(sensor1.readRangeSingleMillimeters()); Serial.print("mm  ");
  ...
  /*Serial.print("(Scaling2 = ");
    ...
    Serial.print("x) ");
  */
  Serial.print("Sensor2 = "); Serial.print(sensor2.readRangeSingleMillimeters()); Serial.print("mm  ");
  ...
  /*Serial.print("(Scaling3 = ");
    ...
    Serial.print("x) ");
  */
  Serial.print("Sensor3 = "); Serial.print(sensor3.readRangeSingleMillimeters()); Serial.print("mm  ");
